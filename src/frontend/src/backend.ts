...
import type { ProjectBrief as _ProjectBrief, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getCallerProjectBrief(): Promise<ProjectBrief | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallerProjectBrief();
    ...
    async saveProjectBrief(arg0: ProjectBrief): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveProjectBrief(to_candid_ProjectBrief_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_ProjectBrief_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ProjectBrief): ProjectBrief {
...
function from_candid_opt_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ProjectBrief]): ProjectBrief | null {
    return value.length === 0 ? null : from_candid_ProjectBrief_n4(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        timeline: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.timeline))
    };
}
...
function to_candid_ProjectBrief_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ProjectBrief): _ProjectBrief {
